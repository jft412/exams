    ...
    it = currentBucket.iterator(); 
        while(it.hasNext()) {
            ...
            if(currentSection.getExamRoom()!=null && currentSection.getExamProctor()!=null){
             ...
             // UPDATE schedule_Flag field with "0" in COURSE table
                String sql = "UPDATE COURSE " +
 	                   "SET schedule_Flag = 0 WHERE call_Number in ("+currentSection.getCallNumber()+")";
...
///////// INSERT RESULTS INTO DATABASE TABLES EXAM_ROOM and EXAM_SCHEDULE /////////// 
...
// get data values to INSERT into database tables        
      ...
      }  // end - for(Section currentSection : courseList){       
...
///// get data values to INSERT into EXAM_SCHEDULE table ///////      
	       ...
	       Statement selectSt3 = conn3.createStatement();
	       ResultSet rs3;
	  ...
	  for(Section currentSection : courseList){
		  ...
		  if(currentSection.getExamRoom()!=null){
 	    		...
 	    		// get department ID for current section's department name
			    ...
			    // get teacher ID for current section's teacher name
		    	...
		    	String substitute;
		    	if(currentSection.getExamProctor().getFullName().equalsIgnoreCase(currentSection.instructor.getFullName())){
		    		substitute = "F";
		    	} else {
		    		substitute = "T";
		    	}		 
		    		
		    	// convert to String values so database will accept values
		    	proctor_Sub[arrayCount2] = String.valueOf(substitute);
		    	call_Number[arrayCount2] = String.valueOf(currentSection.getCallNumber());
		    	  
		    	arrayCount2++;
		    	
	   	}  // end - if(currentSection.getExamRoom()!=null){	    	  
